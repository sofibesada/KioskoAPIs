...
public class DeliveryMethodController {
    ...
    public ResponseEntity<DeliveryMethod> createDeliveryMethod(@RequestBody DeliveryMethodRequest request) {
        DeliveryMethod method = deliveryMethodService.createDeliveryMethod(request.getName(), request.getDescription(),request.getPrice());
    ...
    public ResponseEntity<DeliveryMethod> updateDeliveryMethod(@PathVariable Long id, @RequestBody DeliveryMethodRequest request) {
        DeliveryMethod updated = deliveryMethodService.updateDeliveryMethod(id, request.getName(), request.getDescription(),request.getPrice());
